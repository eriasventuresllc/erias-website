...
const CpuArchitecture = ({
  ...
  return (
    ...
    >
      ...
      {/* 1. Red Light - Changed from Blue to match our theme */}
      ...
      {/* 2. Red Light - Changed from Yellow to match our theme */}
      ...
      {/* 3. Red Light - Changed from Pinkish to match our theme */}
      ...
      {/* 4. Red Light - Changed from White to match our theme */}
      ...
      {/* 5. Red Light - Changed from Green to match our theme */}
      ...
      {/* 6. Red Light - Changed from Orange to match our theme */}
      ...
      {/* 7. Red Light - Changed from Cyan to match our theme */}
      ...
      {/* 8. Red Light - Changed from Rose to match our theme */}
      ...
      <defs>
        ...
        {/* Gradients - Changed all to red to match our brand color */}
        <radialGradient id="cpu-red-grad" fx="1">
          <stop offset="0%" stopColor="hsl(349 36% 65%)" />
          <stop offset="50%" stopColor="hsl(349 36% 52%)" />
        ...
        >
          <circle
            ...
            cy="5"
            r="2"
            fill="hsl(349 36% 52% / 0.3)"
            stroke="hsl(349 36% 52% / 0.2)"
            strokeWidth="0.5"
          >
            {animateMarkers && (
        ...
        <linearGradient
          ...
          y2="1"
        >
          <stop offset="0%" stopColor="hsl(349 36% 52% / 0.4)" />
          <stop offset="60%" stopColor="hsl(349 36% 52% / 0.1)" />
        </linearGradient>
        {/* CPU Text Gradient - Changed to match our theme */}
        <linearGradient id="cpu-text-gradient" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0%" stopColor="hsl(349 36% 30%)">
            <animate
          ...
          <stop offset="25%" stopColor="hsl(349 36% 75%)">
            <animate
              attributeName="offset"
              values="-1; 0; 1"
              dur="5s"
          ...
          <stop offset="50%" stopColor="hsl(349 36% 30%)">
            <animate
              attributeName="offset"
              values="0; 1; 2;"
              dur="5s"
