                ...
                <div className="relative h-full">
                  ...
                  <div className="ml-8 h-full flex items-end justify-between">
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '5%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2018</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '10%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2019</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '20%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2020</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '35%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2021</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '60%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2022</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '75%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2023</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-6 bg-primary/80 rounded-t-sm h-0 transition-height duration-1000" style={{ height: '90%' }}></div>
                      <span className="text-xs mt-1 text-muted-foreground">2024</span>
                    </div>
                  </div>
                </div>
              </div>
